...
<h4 class="box_title">{{$category->category_name}}
 <a href='{{URL::to("categories")}}' class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> Back to Category</a>
</h4>
<div class="box-body col-md-10">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                {{Form::select('home_tag', array('1' => 'Show as home tag', '0' => 'No Tag'), '0', ['class' => 'form-control'])}}
            </div>
        </div>
        ...
        <table class="table table-striped table-hover table-bordered center_table category_table" id="my_table">
            ...
            @foreach($allData as $data)
                <tr>
                    ...
                    <td><a class="label label-warning" href='{{URL::to("subSubCategory/$data->id")}}'>Sub Sub Category</a></td>
                    <td><a class="label label-success" href='{{URL::to("sub-attribute/$data->id")}}'><i class="fa fa-plus"></i> Attribute</a></td>

                    <td>{{$data->created_at}}</td>
                    <td><a href="#editModal{{$data->id}}" data-toggle="modal" class="btn btn-info"><i class="fa fa-edit"></i></a>
                    <!-- Modal -->
<div class="modal fade" id="editModal{{$data->id}}" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <input type="hidden" name="fk_category_id" value="{{$category->id}}">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                {{Form::select('home_tag', array('1' => 'Show as home tag', '0' => 'No Tag'),$data->home_tag, ['class' => 'form-control'])}}
            </div>
        </div>
