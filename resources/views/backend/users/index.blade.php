...
<h4 class="header-title m-t-0 m-b-30"><i class="fa fa-pencil" aria-hidden="true"></i> View All User Information</h4>
                    ...
                    <td> {{$data->name}}</td>
                    <td>{{$data->email}}</td>
                    <td><a href="{{route('view-users.edit',$data->id)}}" class="label label-danger">Reset Password</a></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        {!! Form::open(array('route' => ['view-users.update',$data->id],'class'=>'form-horizontal','method'=>'PUT')) !!}
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                {{Form::number('phone',$data->phone,array('class'=>'form-control','placeholder'=>'01xxxxxxxxx','required','min'=>0))}}
            </div>
        </div>
      ...
      <div class="modal-footer">
        ...
        {!! Form::close() !!}
                    ...
                    <td>
        {!! Form::open(array('route' => ['view-users.destroy',$data->id],'method'=>'DELETE')) !!}
