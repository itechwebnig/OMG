        ...
        <table class="table table-striped table-hover table-bordered center_table" id="my_table">
            ...
            @foreach($allData as $data)
                <tr>
                    ...
                    <td>
                    <a href="{{route('all-brand.edit',$data->id)}}" class="btn btn-info waves-effect w-xs waves-light m-r-5 m-b-10 action_btn" title="Item Edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
