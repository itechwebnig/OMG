  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li><a href='<?php echo e(URL::to("category/$category->link")); ?>'><?php echo e($category->category_name); ?></a></li>
        <li class='active'><?php echo e($s_category->sub_category_name); ?></li>
      </ul>
    </div>
    <!-- /.breadcrumb-inner --> 
  </div>
        ...
        <div class="side-menu custom_sideber_menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal categoryMenu">
              ...
              if(isset($part[3])){
               ...
               ?>
                <li  class="<?php echo e(($catLink==$catUrl)?'active':''); ?>"> <a href='<?php echo e(URL::to("category/$s_category->cat_link/$s_category->link")); ?>'><?php echo e($s_category->sub_category_name); ?></a><?php if(count($subSub)>0): ?> <button class="btn btn-xs pull-right btn-info " data-toggle="collapse" href="#subSubMenu<?php echo e($s_category->id); ?>" ><i class="fa fa-plus"></i></button> 
                  <ul  id="subSubMenu<?php echo e($s_category->id); ?>" class="panel-collapse collapse <?php echo e(($catLink==$catUrl)?'in':''); ?> categorySubMenu">
                     ...
                     <? $subCatLink="category/$s_category->cat_link/$s_category->link/$link"; ?>
                      <li><a class="<?php echo e(($url==$subCatLink)?'active':''); ?>" href='<?php echo e(URL::to("category/$s_category->cat_link/$s_category->link/$link")); ?>'><i class="fa fa-angle-double-right"></i> <?php echo e($name); ?></a></li>
