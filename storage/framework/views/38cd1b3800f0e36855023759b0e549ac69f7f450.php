...
<h3 class="box_title">Edit Brand
 <a href="<?php echo e(route('all-brand.index')); ?>" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View All</a></h3>
    <?php echo Form::open(array('route' => ['all-brand.update', $data->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)); ?>
        ...
        <div class="form-group <?php echo e($errors->has('photo') ? 'has-error' : ''); ?>">
            ...
            <div class="col-md-8">
                <label class="upload_photo upload" for="file">
                    <!--  -->
                    <img src="<?php echo e(asset('public/img/brand/'.$data->photo)); ?>" id="image_load">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php echo e(Form::text('name',$data->name,array('class'=>'form-control','placeholder'=>'Brand Name'))); ?>
