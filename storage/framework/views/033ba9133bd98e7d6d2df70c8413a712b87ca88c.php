...
<div class="tab_content">
 ...
 <a href="<?php echo e(route('reviews.create')); ?>" class="btn btn-default pull-right"> <i class="ion ion-plus"></i> Add new </a></h3>
        <table class="table table-striped table-hover table-bordered center_table" id="my_table">
            ...
            <?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <tr>
                    <td><?php echo e($i++); ?>.</td>
                    <td><a href="<?php echo e(route('reviews.edit',$data->id)); ?>"><?php echo e($data->name); ?></a></td>
                    ...
                    <td>
        <?php echo Form::open(array('route' => ['reviews.destroy',$data->id],'method'=>'DELETE')); ?>
