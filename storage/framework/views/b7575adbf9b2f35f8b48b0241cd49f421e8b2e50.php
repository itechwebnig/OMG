        ...
        <table class="table table-striped table-hover table-bordered center_table" id="my_table">
            ...
            <? $i++; ?>
                <tr>
                    ...
                    <td>
        <a href="<?php echo e(route('offer.edit',$data->id)); ?>" class="btn btn-info waves-effect w-xs waves-light m-r-5 m-b-10 action_btn" title="Item Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
