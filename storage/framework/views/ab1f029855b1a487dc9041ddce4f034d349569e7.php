		...
		<div class="row">
			...
			<div class="col-md-3 contact-info">
				...
				<div class="clearfix address">
					...
					<span class="contact-span"><?php echo e($info->address); ?></span>
				</div>
				<div class="clearfix phone-no">
					<span class="contact-i"><i class="fa fa-mobile"></i></span>
					<span class="contact-span"><?php echo e($info->mobile_no); ?></span>
				</div>
				<div class="clearfix email">
					<span class="contact-i"><i class="fa fa-envelope"></i></span>
					<span class="contact-span"><a href="#"><?php echo e($info->email); ?> </a></span>
				</div>
				<br>

			</div>
			<div class="col-md-12 contact-map outer-bottom-vs">
					<iframe src="<?php echo e($info->map_embed); ?>" width="600" height="450"  style="border:0"></iframe>
				</div>
		</div><!-- /.contact-page -->
	</div><!-- /.row -->
</div>
