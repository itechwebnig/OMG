<?php if(isset($value) && count($subCat>0)): ?>    

  <div class="form-group role_select" >
    <label class="control-label col-sm-3">Select Sub Category* </label>
    <div class="col-sm-9">
    <?php echo e(Form::select('fk_sub_category_id',$subCat,'',['class'=>'chosen-select-no-results_cat','id'=>'sub_category','placeholder'=>'Select Sub Category','required'])); ?>
