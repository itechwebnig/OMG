 ...
 <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View All</a></h3>
	<?php echo Form::open(array('route' => 'categories.store','class'=>'form-horizontal','id'=>'form_submit','files'=>true)); ?>
     ...
     <div class="form-group  <?php echo e($errors->has('display_in_mainmenu') ? 'has-error' : ''); ?>">
        ...
        <div class="col-md-6">
            <div class="col-md-3"><label class="btn btn-success"><input type="radio" name="display_in_mainmenu" value="1"> Yes </label> </div>
            <div class="col-md-3"><label class="btn btn-danger"><input type="radio" name="display_in_mainmenu" value="0" checked> No </label> </div>
        </div>
