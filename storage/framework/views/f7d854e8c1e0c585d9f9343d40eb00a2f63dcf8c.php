...
<h3 class="box_title">Edit Slide
 <a href="<?php echo e(route('slider.index')); ?>" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View All Slide</a></h3>
    <?php echo Form::open(array('route' => ['slider.update', $data->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)); ?>
        ...
        <div class="form-group <?php echo e($errors->has('slide_photo') ? 'has-error' : ''); ?>">
            ...
            <div class="col-md-8">
                <label class="upload_photo upload" for="file">
                    <!--  -->
                    <img src="<?php echo e(asset($data->slide_photo)); ?>" id="image_load">
                    <i class="upload_hover ion ion-ios-camera-outline"></i>
                </label>
                <?php echo e(Form::file('slide_photo',array('id'=>'file','style'=>'display:none'))); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php echo e(Form::text('top_caption',$data->top_caption,array('class'=>'form-control','placeholder'=>'Top Caption'))); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php echo e(Form::text('slide_caption',$data->slide_caption,array('class'=>'form-control','placeholder'=>'Middle Caption'))); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php echo e(Form::text('bottom_caption',$data->bottom_caption,array('class'=>'form-control','placeholder'=>'Bottom Caption'))); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php echo e(Form::select('fk_category_id',$categories,$data->fk_category_id, ['class' => 'form-control','placeholder'=>'Select a category'])); ?>
