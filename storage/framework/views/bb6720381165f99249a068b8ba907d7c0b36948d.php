...
<h3 class="box_title">Edit Offer
 <a href="<?php echo e(route('offer.index')); ?>" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View All</a></h3>
    <?php echo Form::open(array('route' => ['offer.update', $data->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)); ?>
       ...
       <div class="form-group" >
              ...
              <select name="fk_category_id" data-placeholder="- Select -" style="width:100%;" class="chosen-select" tabindex="10" required="required" onchange="loadSubCategory(this.value)">
                <?php if($category): ?>
                  <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryData): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <option value="<?php echo e($categoryData->id); ?>" <?php if($itemInfo->fk_category_id == $categoryData->id): ?><?php echo e("selected"); ?> <?php endif; ?>><?php echo e($categoryData->category_name); ?></option>
        ...
        <div id="loadSubCategory">
            <?php if($itemInfo->fk_sub_category_id!=null): ?>
            <div class="form-group" >
                  ...
                  <select name="fk_sub_category_id" data-placeholder="- Select -" style="width:100%;" class="chosen-selects" tabindex="10">
                    <?php if($subCategory): ?>
                      <?php $__currentLoopData = $subCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategoryData): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <?php if($itemInfo->fk_category_id == $subCategoryData->fk_category_id): ?>
                            <option value="<?php echo e($subCategoryData->id); ?>" <?php if($itemInfo->fk_sub_category_id == $subCategoryData->id): ?><?php echo e("selected"); ?> <?php endif; ?>><?php echo e($subCategoryData->sub_category_name); ?></option>
                        <?php endif; ?>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    <?php endif; ?>
                  </select>
        ...
        <div id="loadItem">
            <div class="form-group">
                <?php echo e(Form::label('fk_item_id', 'Select Item', array('class' => 'col-md-3 control-label'))); ?>
                ...
                <div class="col-md-8">
                    <select name="fk_item_id" data-placeholder="Choose a Item..." class="form-control chosen" style="width: 100%;" onchange="price(this.value)">
                        ...
                        <option value="<? echo $item->id ?>" <?php echo e(($item->id==$data->fk_item_id)?'selected':''); ?>><? echo $item->item_name ?></option>
                        <?} ?>
                    </select>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="input-group">
                  <?php echo e(Form::number('discount',$data->discount,['class'=>'form-control','placeholder'=>'Ex: 33','min'=>'0','step'=>'any','id'=>'discount'])); ?>
            ...
            <div class="col-md-3">
                <?php echo e(Form::number('regular_price',$data->regular_price,['class'=>'form-control','placeholder'=>'Regular Price','min'=>'0','step'=>'any','id'=>'regularPrice'])); ?>

                <span>Regular Price</span>
            </div>
            <div class="col-md-3">
                <?php echo e(Form::number('sale_price',$data->sale_price,['class'=>'form-control','placeholder'=>'Sale Price','min'=>'0','step'=>'any','id'=>'salePrice'])); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php echo e(Form::date('start_date',$data->start_date,['class'=>'form-control','placeholder'=>'Start Date'])); ?>

                <span>Start Date</span>
            </div>
            
            <div class="col-md-4">
                <?php echo e(Form::date('end_date',$data->end_date,['class'=>'form-control','placeholder'=>'End Date'])); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php echo e(Form::select('offer_type', array('1' => 'Todays Offer', '2' => 'Regular Offer'),$data->offer_type, ['class' => 'form-control'])); ?>
