 ...
 <a href="<?php echo e(route('pages.index')); ?>" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View All </a>
    ...
    <?php echo Form::open(array('route' => ['pages.update', $data->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php echo e(Form::textArea('description',$data->description,array('class'=>'form-control ','id'=>'ckeditor','placeholder'=>'Write some thing about pages','rows'=>'5'))); ?>
                    ...
                    <div id="formdiv">
                        <div class="img_control">
                          ...
                          if(!empty($data->photo)){
                            ...
                            <div id="filediv">
                                <div id="abcd" class="abcd"><img id="previewimg" src="<?php echo e(asset('public/img/pages/'.$photo['photo'])); ?>"><input type="hidden" id="exist_file" value="<? echo $photo['id']; ?>" /><img id="exist_img" src="<?php echo e(asset('public/img/x.png')); ?>" alt="X" title="Delete"></div>
                            </div>
