...
<h4 class="box_title">Attribute  <?php if(isset($allData['sub_sub_category'])): ?>
<?php echo e("of '".$allData['sub_sub_category']['sub_category_name'].' : '.$allData['sub_sub_category']['sub_name']."'"); ?>

<? $sub_cat_id=$allData['sub_sub_category']['sub_category_id']; ?>
<?php endif; ?>
 <a href='<?php echo e(URL::to("subSubCategory/$sub_cat_id")); ?>' class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View Sub Sub Category</a></h4>
    ...
    <?php echo Form::open(array('route' => 'attribute.store','class'=>'form-horizontal','id'=>'form_submit')); ?>
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::hidden('fk_sub_sub_category_id',"$fk_sub_sub_category_id")); ?>
