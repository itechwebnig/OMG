...
<h4 class="header-title m-t-0 m-b-30"><i class="fa fa-pencil" aria-hidden="true"></i> View All User Information <a href="<?php echo e(route('users.create')); ?>" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> Add new user</a></h4>
                                    <hr>
                                        ...
                                        <?php $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <tr>
                    <td><?php echo e($i++); ?></td>
                    <td> <a href="<?php echo e(route('users.show',$data->id)); ?>" class="btn btn-link"><?php echo e($data->name); ?></a></td>
                    ...
                    <td><a href="#editModal<?php echo e($data->id); ?>" data-toggle="modal" class="btn btn-info"><i class="fa fa-edit"></i></a>
                    <!-- Modal -->
