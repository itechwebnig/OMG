                      ...
                      <div class="yamm-content">
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                            <h2 class="title"><a href="<?php echo e(URL::to("category/$cat_name->link")); ?>"><?php echo e($cat_name->category_name); ?></a></h2>
                            <ul class="links">
                              ...
                              <li><a href="<?php echo e(URL::to("category/$cat_name->link/$subcat_name->link")); ?>"><?php echo e($subcat_name->sub_category_name); ?></a></li>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                            </ul>
                          </div>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
