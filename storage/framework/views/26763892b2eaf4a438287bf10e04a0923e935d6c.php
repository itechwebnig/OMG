 ...
 <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View All</a></h3>
    <?php echo Form::open(array('route' => ['categories.update', $data->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)); ?>
        ...
        <?php endif; ?>
             ...
             <div class="form-group  <?php echo e($errors->has('display_in_mainmenu') ? 'has-error' : ''); ?>">
            <?php echo e(Form::label('display_in_mainmenu', 'Show in Mainmenu', array('class' => 'col-md-3 control-label'))); ?>

        <div class="col-md-6">
            <div class="col-md-3"><label class="btn btn-success"><input type="radio" name="display_in_mainmenu" value="1" <?php echo e(($data->home_status==1)? 'checked' : ''); ?>> Yes </label> </div>
            <div class="col-md-3"><label class="btn btn-danger"><input type="radio" name="display_in_mainmenu" value="0" <?php echo e(($data->display_in_mainmenu==0)? 'checked' : ''); ?>> No </label> </div>
        </div>
        <?php if($errors->has('display_in_mainmenu')): ?>
            <span class="help-block">
                <strong><?php echo e($errors->first('home_status')); ?></strong>
            </span>
        <?php endif; ?>
