...
<h4 class="box_title">Attribute  <?php if(isset($allData['category'])): ?>
<?php echo e('of "'.$allData['category']['category_name'].'"'); ?>

<?php endif; ?>
 <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View Category</a></h4>
    <?php echo Form::open(array('route' => 'attribute.store','class'=>'form-horizontal','id'=>'form_submit')); ?>
        ...
        <div class="form-group">
            ...
            <? $fk_category_id=$allData['fk_category_id']; ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <?php echo e(Form::select('attribute_type', array('1' => 'Select Option', '2' => 'Check Box'),$data->attribute_type, ['class' => 'form-control','required'])); ?>
